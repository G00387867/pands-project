...
* Creating a plot showing the correlation between the different variable categories.
...
### _Pair Scatter_ using SEABORN 

![Pair-Scatter](https://github.com/G00387867/pands-project/blob/master/Pair_Scatter.png "Pair Scatter")
